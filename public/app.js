...
// The quiz controller
 ...
 dogfacts.controller("quizcntrl",["$scope","quizM","dataHandle",function($scope,quizM,dataHandle)
 {
        ...
        $scope.dataHandle=dataHandle;
         ...
         // setQActive function find the next unanswered question
      ...
      function quizM(dataHandle)
 {
      var quizobj=
      {
         ...
         markQuiz:function()
         {
         	quizobj.correctAnswers = dataHandle.correctAnswers;
    ...
    var dogsData =
         ...
         [
            ...
            },
            {
                ...
                description: "German Shepherds are medium to large-sized dogs. The breed standard height at the withers is 60–65 cm (24–26 in) for males, and 55–60 cm (22–24 in) for females. German Shepherds are longer than tall, with an ideal proportion of 10 to 8 1/2. The AKC official breed standard does not set a standard weight range. They have a domed forehead, a long square-cut muzzle with strong jaws and a black nose. The eyes are medium-sized and brown with a lively, intelligent and self-assured look. The ears are large and stand erect, open at the front and parallel, but they often are pulled back during movement (https://en.wikipedia.org/wiki/German_Shepherd)."
            },
            {
                type: "Poodle",
                ...
                description: "The poodle is a group of formal dog breeds, the Standard Poodle, Miniature Poodle and Toy Poodle. The origin of the breed is still discussed, with a prominent dispute over whether the poodle descends from Germany as a type of water dog, or from the French Barbet. Ranked second most intelligent dog breed just behind the Border Collie, the poodle is skillful in many dog sports and activities, including agility, obedience, tracking to herding, circus performers or assistance dogs. Poodles have taken top honors in many conformation shows, including Best in Show at the Westminster Kennel Club Dog Show in 1991 and 2002, and at the World Dog Show in 2007 and 2010 (https://en.wikipedia.org/wiki/Poodle)."
            },
            {
                type: "Bulldog",
            ...
            },
            {
                ...
                description: "The Siberian Husky is a medium size working dog breed that originated in Northeast Asia. The breed belongs to the Spitz genetic family. It is recognizable by its thickly furred double coat, erect triangular ears, and distinctive markings. The original Siberian Huskies were bred by the Chukchi people — whose hunter-gatherer culture relied on their help. It is an active, energetic, resilient breed, whose ancestors lived in the extremely cold and harsh environment of the Siberian Arctic. William Goosak, a Russian fur trader, introduced them to Nome, Alaska during the Nome Gold Rush, initially as sled dogs. The people of Nome referred to Siberian Huskies as Siberian Rats due to their size of 40–50 lb (18–23 kg), versus the Malamutes size of 75–85 lb (34–39 kg) (https://en.wikipedia.org/wiki/Siberian_Husky)."
            },
            {
                type: "Great Dane",
